...
var unmarshalTests = []unmarshalTest{
	...
	// InvalidDataError
	{in: "82a15812", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "82", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "82a15812", ptr: new(map[string]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "82", ptr: new(map[string]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "de0002a15812", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "de0002", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "de0002a15812", ptr: new(map[string]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "de0002", ptr: new(map[string]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "df00000002a15812", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "df00000002", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "df00000002a15812", ptr: new(map[string]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "df00000002", ptr: new(map[string]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "9212", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "92", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "9212", ptr: new([2]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "92", ptr: new([2]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "9212", ptr: new([]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "92", ptr: new([]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dc000212", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dc0002", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dc000212", ptr: new([2]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dc0002", ptr: new([2]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dc000212", ptr: new([]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dc0002", ptr: new([]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dd0000000212", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dd00000002", ptr: new(Pair), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dd0000000212", ptr: new([2]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dd00000002", ptr: new([2]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dd0000000212", ptr: new([]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "dd00000002", ptr: new([]int), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "a548656c6c", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "a5", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d90548656c6c", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d905", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "da000548656c6c", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "da0005", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "db0000000548656c6c", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "db00000005", ptr: new(string), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c40548656c6c", ptr: new([]byte), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c405", ptr: new([]byte), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c5000548656c6c", ptr: new([]byte), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c50005", ptr: new([]byte), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c60000000548656c6c", ptr: new([]byte), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c600000005", ptr: new([]byte), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c7050348656c6c", ptr: new(SS), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c705", ptr: new(SS), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c800050348656c6c", ptr: new(SS), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c80005", ptr: new(SS), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c9000000050348656c6c", ptr: new(SS), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "c900000005", ptr: new(SS), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "ca4015c2", ptr: new(float32), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "cb4002b851eb851e", ptr: new(float64), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "cc", ptr: new(uint8), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "cd4b", ptr: new(uint16), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "ce004b6b", ptr: new(uint32), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "cf0000004b6b34ab", ptr: new(uint64), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d0", ptr: new(int8), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d1b4", ptr: new(int16), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d2ffb494", ptr: new(int32), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d3ffffffb494cb54", ptr: new(int64), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d401", ptr: new(opacity), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d50212", ptr: new(position), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d6ff62b2d9", ptr: new(Timestamp), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d7ffee6b27fc62b2", ptr: new(Timestamp), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
	{in: "d8050123456789abcdef0123456789abcd", ptr: new(ext16), err: &InvalidDataError{"unexpected end of MessagePack input", int64(1)}},
}
